...
import { emptyValue, formatDate } from './patientDetailFormatters';
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Observações sobre setores de conflito', value: record.conflictSectorsNotes || emptyValue },
      ],
    },
    {
      ...
      items: [
        ...
        { label: 'Observações sobre estilo de personalidade', value: record.personalityStyleNotes || emptyValue },
        ...
        { label: 'Observações sobre dinâmica psíquica', value: record.psychicDynamicsNotes || emptyValue },
      ],
    },
    {
      ...
      items: [
        ...
        { label: 'Anotação sobre constância do self', value: record.clinicalAnalysis?.selfConstancyNotes || emptyValue },
        ...
        { label: 'Anotação sobre constância objetal', value: record.clinicalAnalysis?.objectConstancyNotes || emptyValue },
        ...
        { label: 'Observações sobre análise clínica', value: record.clinicalAnalysisNotes || emptyValue },
      ],
    },
    {
      ...
      items: [
        ...
        { label: 'Observações sobre tratamento', value: record.treatmentNotes || emptyValue },
...
export function PatientProntuarioTab({ record }: { record: PatientRecord | null }) {
  if (!record) {
    return (
