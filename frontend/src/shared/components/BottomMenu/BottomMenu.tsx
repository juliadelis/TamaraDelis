        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex min-w-0 flex-col items-center justify-center gap-1 border-t-2 transition-colors ${
                isActive
                  ? "border-[#6A3710] text-[#6A3710]"
                  : "border-transparent text-[#1E1E1E] hover:text-[#6A3710]"
              }`}
            >
